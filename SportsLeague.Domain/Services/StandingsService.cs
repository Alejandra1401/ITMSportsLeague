...
namespace SportsLeague.Domain.Services
{
...

    {
...

        {
            ...
            //El ToDictionary me sirve para crear un diccionario a partir de una colección,
            //donde la clave es el MatchId y el valor es el MatchResult correspondiente.
            //Esto me permite acceder rápidamente al resultado de un partido dado su ID
            //sin tener que buscar en toda la lista de resultados cada vez.
            ...
            var standings = tournamentTeams.Select(tt =>
            {
                ...
                //Count me sire para contar el numero de elementos en la colección que cumplen la condición especifica 
                //En este caso, estoy contando cuántos partidos como local el equipo ganó,
                //es decir, cuántos resultados tienen más goles en casa que goles fuera.
