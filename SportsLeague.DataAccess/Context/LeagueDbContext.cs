...
namespace SportsLeague.DataAccess.Context
{
    public class LeagueDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)//METODO PARA MODELAR LAS ENTIDADES SEGUN SUS PROPIEDADES 
        {
            ...
            modelBuilder.Entity<Player>(entity =>
            {
                ...
                entity.HasOne(p => p.Team)
                      ...
                      .OnDelete(DeleteBehavior.Cascade);//el borrador en cascada me elimina a todos los jugadores que esten asociados a un equipo cuando se borra el equipo

                // Índice único compuesto: número de camiseta único por equipo
                entity.HasIndex(p => new { p.TeamId, p.Number })//Por cada equipo solo puede haber un jugador con un número de camiseta específico, evitando duplicados dentro del mismo equipo
                      .IsUnique();
            });
            ...
            modelBuilder.Entity<Match>(entity =>
            {
                ...
                entity.HasOne(m => m.Tournament)
                      ...
                      .OnDelete(DeleteBehavior.Cascade);//ELIMINACION EN CASCADA, SI SE ELIMINA UN TORNEO SE ELIMINAN TODOS LOS PARTIDOS ASOCIADOS A ESE TORNEO
            ...
            modelBuilder.Entity<MatchResult>(entity =>
            {
                ...
                entity.HasOne(mr => mr.Match)
                      .WithOne(m => m.MatchResult)//Aqui es donde defino la relacion 1:1 
