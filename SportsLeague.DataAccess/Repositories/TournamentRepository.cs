    ...
    public class TournamentRepository : GenericRepository<Tournament>, ITournamentRepository
    {
        ...
        public async Task<Tournament?> GetByIdWithTeamsAsync(int id)
        {
            return await _dbSet
                ...
                .FirstOrDefaultAsync();
            //Primero estoy en torneo ---> luego para recuperar los equpos de ese torneo debo pasar obligatoriamente
            //por la tabla intermedia TournamentTeams --->
            // y luego de eso puedo recuperar los equipos que participan en ese torneo
        }
    }
}
